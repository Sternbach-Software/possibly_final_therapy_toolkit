...
public abstract class MatchableRVArrayAdapter<T, VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> implements Filterable {
    ...
    abstract void onBindHolder(T item, VH holder, int position);
     ...
     * @return whether condition matches global variables textWhichUserSearchedFor or prerequisiteConditions
     */
    protected boolean matches(T value) {
//            return new FilterCondition().matches((Condition)value);
    return true;
    }
